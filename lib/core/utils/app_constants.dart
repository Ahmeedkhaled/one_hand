...
class AppConstants {
  static const String appName = 'ONe hand';
  ...
  static const String installmentListUri = '/api/v1/pos/installment/list';
  static const String installmentDataUri = '/api/v1/pos/installment/invoice';

  static const String reservationListUri = '/api/v1/product/reservation/list';
  static const String updateListUri = '/api/v1/stocks/history';
  ...
  // static const String getCategoryListUriForSeller = '/api/v1/category/list';
  ...
  static const String addNewInstallmentCustomerUri =
      '/api/v1/pos/place/installment';
  static const String priceForCustomer = '/api/v1/product/customer/price';
  static const String changePriceForCustomer = '/api/v1/product/customer/price/change';
  ...
  static const String categoriesProductStockUri = '/api/v1/stocks/list';
  ...
  static const String placeReservationUri = '/api/v1/product/reservation/place';
  //update data
  static const String updateDataUri = '/api/v1/stocks/confirm';
