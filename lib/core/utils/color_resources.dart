...
//         ? const Color.fromARGB(255, 0, 13, 189)
//         : const Color.fromARGB(255, 72, 105, 255);
//   }

//   static Color getSplashColor1() {
//     return Get.isDarkMode
//         ? const Color.fromARGB(255, 0, 31, 204).withOpacity(.15)
//         : const Color.fromARGB(255, 0, 20, 204).withOpacity(.15);
//   }
